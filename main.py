"""Find the largest scale-adjusted number in a PDF."""
...
def find_largest(pages):
    ...
    Output: The largest scale-adjusted value in the document.
    ...
    The result is a (value, page_number, line_index) tuple.
    """
...
if __name__ == "__main__":
    ...
    adj_value, adj_page, adj_line = find_largest(pages)
